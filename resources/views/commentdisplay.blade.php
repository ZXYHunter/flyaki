@if($displayinfo['background']=='black')
    <div class="displaycomments col-md-12 col-sm-12 col-xs-12" style="background-color: rgba(205,205,205,1);width:100%;padding-top:10px;">
        @else
            <div class="col-md-12 col-sm-12 col-xs-12" style="padding-top:10px;width:100%;">
                @endif
                ...
                <div class="col-md-9 col-sm-9 col-xs-9" style=" margin-top: 20px;">
                    ...
                    @endif
                        <span class="timestamp" style="position:absolute; right:5%;">{{ ''.substr($displayinfo['created_at'],0,10) }}</span>
                    </p>
                    <p>
                        @for($i=0;$i<5;$i++)
                            ...
                            @endif
                        @endfor
                            @if($displayinfo['price'])
                                <span style="text-align: left;font-size: 14px;"><span style="font-size: 14px;" class="glyphicon glyphicon-yen"></span>{{ $displayinfo['price'] }}</span>
                            @endif
                    </p>
                    <p style="font-size: 12px;">{{ $displayinfo['content'] }}</p>
                </div>
                <div class="col-md-3 col-sm-3 col-xs-3">
                    <p style="font-size: 12px;margin-left: -20px;margin-top:30px;text-align: left"></p>
                </div>
            </div>