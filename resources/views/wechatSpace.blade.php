<div  class="mydiv">
    ...
    <div style="text-align: center">
        <img class="img-circle" src="{{ $host['photoaddr'] }}" alt="Source Error" style="width: 80%">
        <h2>{{ $host['name'] }}</h2>
    </div>
    <div style="width: 80%; margin-left: 10%">
        <span>
                    <p style="text-align: center; font-weight: bold">大学信息<br>
        ...
        <span style="background-color: rgba(233,233,233,1); ">
                    <p style="text-align: center; font-weight: bold">专业信息<br>
                    <span style="color: #000000; text-align: center; font-weight: normal">{{ $host['major'] or '主人没有填写专业信息' }}</span>
                    </p>
        </span>
        <span>
                    <p style="text-align: center; font-weight: bold">个人简介<br>
                    <span style="color: #000000; text-align: center; font-weight: normal">{{ $host['consultant']['briedintroduction'] }}</span>
                    </p>
        </span>
        <span style="background-color: rgba(233,233,233,1);">
                    <p style="text-align: center; font-weight: bold">个人专长<br>
                    <span style="color: #000000; text-align: center; font-weight: normal">{{ $host['consultant']['strength'] }}</span>
                    </p>
        </span>
